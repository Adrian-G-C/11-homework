...
if (window.location.pathname === '/notes') {
  ...
  noteList = document.querySelector('.list-container .list-group'); // Updated to select single list element
}
